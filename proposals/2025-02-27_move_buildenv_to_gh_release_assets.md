...
2. Update the buildenv script to fetch from GH instead
3. Remove the artifact upload to the `download.mixxx.org` server after the notice period
4. Remove all remaining artifacts from `download.mixxx.org` after another, longer the notice period
