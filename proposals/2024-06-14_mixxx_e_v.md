...
1. Membership is open to natural persons and legal bodies supporting the
   ...
   4. **Supporting Members**: Extraordinary members primarily supporting
...
1. Core membership is granted upon suggestion or application by the General
   Assembly or through an internet vote of the core members. Criteria include
   long-term commitment and contributions.
2. A core member can change status to that of an extraordinary member by
   ...
   procedure.
3. Membership terminates due to withdrawal, expulsion, death, or loss of legal
   ...
   submitted.
4. The expulsion of a member may be decided by the General Assembly or by an
