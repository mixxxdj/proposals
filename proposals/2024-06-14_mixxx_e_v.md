...
1. „Mixxx“ ist der Name der freien und quelloffenen DJ-Software, die der Verein
   ohne Lizenzkosten zur Verfügung stellt. Sie ermöglicht Künstlern das
...
1. Zweck des Vereins ist die Förderung von Kunst und Kultur, sowie die Volks-
   und Berufsbildung. Der Verein bietet Künstlern die Grundbausteine für ihre
   ...
   DJing zu beginnen und ermöglicht Softwareentwicklern, Implementierungsdetails
...
2. Der Satzungszweck wird insbesondere verwirklicht durch:
   ...
   2. das Erstellen von Dokumentation und Anleitungen, um das Lernen und die
...
1. Mitglieder des Vereins können natürliche und juristische Personen werden,
   ...
   3. **Fördernde Mitglieder**: Außerordentliche Mitglieder, die durch
      finanzielle oder Sachbeitrage unterstützen. Sie haben die Möglichkeit
...
2. Die Kernmitgliedschaft wird auf Vorschlag oder Antrag der
   ...
   gewährt. Zu den Kriterien gehören langfristiges Engagement und Mitarbeit.
3. Ein Kernmitglied kann in den Status eines außerordentlichen Mitglieds
   ...
   Mitgliedschaft automatisch in eine außerordentliche. Auf Antrag kann der Vorstand eine Ausnahme von diesem Automatismus gewähren.
4. Die Mitgliedschaft endet durch Austritt, Ausschluss oder Tod, sowie bei 
...
5. Der Ausschluss eines Mitglieds kann von der Mitgliederversammlung oder durch
   eine Internetabstimmung der Kernmitglieder beschlossen werden, wenn eine kritische Situation
   ...
   * b) Nichtbezahlen von Mitgliedsbeiträgen über einen Zeitraum von 12 Monaten.
   ...
   rechtfertigen. Betrifft dies ein Kernmitglied, behält dieses bis zum Ausschluss sein Stimmrecht.
   Im Falle von b), kann der Vorstand Zugriffsrechte auf die Infrastruktur des Vereins entziehen und dem Mitglied untersagen im Namen des Vereins zu kommunizieren.
...
2. Die Aufgaben des Vorstands und der Ablauf der Sitzungen wird durch eine
   Geschäftsordnung des Vorstands geregelt. Der Vorsitzende ist dabei
   für die Verfolgung des Vereinszwecks, die Einhaltung der Satzung und die
   Delegation von Aufgaben verantwortlich. Der zweite Vorsitzende vertritt den
   Vorsitzenden bei dessen Abwesenheit und überprüft die Beschlüsse des
   Vorstands und der Mitgliederversammlungen. Der Schatzmeister verwaltet die
   Finanzen des Vereins, führt die Kassenbücher und die Mitgliederliste.
...
Der Verein kann Abstimmungen über das Internet durchführen. Eine
...
2. Free and Open Source Software (FOSS) refers to computer programs that
...
3. Developing free and open source software involves research, compilation of
...
3. A core member can change status to that of an extraordinary member by
   ...
   Upon request, the Board may grant an exception to this automatic procedure.
...
5. The expulsion of a member may be decided by the General Assembly or by
   an Internet Vote of core members in the event of a critical situation where an amicable solution
...
6. Members leaving the Association or if the Association is liquidated do not
   have a right to reimbursement for contributed assets. If this concerns a core member,
   this member retains their voting rights until they are excluded.
...
2. The Board’s duties and meeting procedures are stipulated in the by-laws.
   The Chairman is responsible responsible for following the purpose of the
   association, complying with the Articles of Association and delegation of
   tasks. The second chairperson represents the Chairman in his absence and
   verifies the resolutions of the Board and the General Assembly. The
   treasurer manages the finances of the association, keeps the cash books and
   the list of members.
