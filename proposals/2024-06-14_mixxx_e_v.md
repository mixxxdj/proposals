...
1. The Association’s purpose is explain the basics in digital DJ-ing to 
   ...
   research. The Association does not suplly the music played with it's 
   distributed software, the user takes all responsabilities about the rights 
   of played music.
...
1. In order to fulfill the purposes and tasks of the association, personal data
   ...
   Act (BDSG).
2. The organs of the Association and other persons working for it are prohibited 
   from processing personal data or or making it accessible to third parties, 
   without authorization for purposes other than the respective task. This 
   obligation also applies after the above-mentioned persons have left the 
   Association.
